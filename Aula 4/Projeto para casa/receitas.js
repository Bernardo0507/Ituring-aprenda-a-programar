...
//Exercicio 1
var somatoriocomgorjeta = 0
var somatorio = 0
var vendasmenorque50 = 0
for (let index = 0; index < receita.length; index++) {
    somatorio = somatorio + receita[index].valor
    somatoriocomgorjeta = somatorio + receita[index].valor + receita[index].gorjeta
    if (receita[index].valor < 50) {
        console.log(`As vendas menor que 50 foram: ${receita[index].valor}`)
        vendasmenorque50++
    }
}
console.log(`Valor sem gorjeta:${somatorio}valor com gorjeta ${somatoriocomgorjeta}`)
console.log(`Vendas menor que 50 reais:${vendasmenorque50}`)
